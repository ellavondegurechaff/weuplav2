import { AppShell, Container, Grid, Card, Text, Image, Group, Burger, Button, TextInput, Modal } from '@mantine/core'
  ...
  useEffect(() => {
    async function fetchEdibles() {
      try {
        ...
        console.error('Error fetching edible products:', error)
      }
    }
    fetchEdibles()
  }, [])
      ...
      >
        <AppShell.Header>
          <Group h="100%" px="md" style={{ justifyContent: 'space-between' }}>
            ...
            <Text size="2rem" fw={700} c="#f97316">Disposables / Carts / Edibles</Text>
