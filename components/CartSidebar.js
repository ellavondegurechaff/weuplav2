...
export function CartSidebar({ isCartOpen, setIsCartOpen, activePage }) {
  ...
  return (
    <>
      ...
      <div 
        className={`fixed right-0 w-full sm:w-96 bg-[#ECDCB9] shadow-xl transform 
          ${isCartOpen ? 'translate-x-0' : 'translate-x-full'}
          top-0 h-full transition-transform duration-300 ease-in-out z-[160]`}
      >
        <div className="h-full flex flex-col pt-16">
          <div className="px-4 py-3 bg-[#ECDCB9] flex justify-between items-center border-b border-orange-100">
          ...
          {/* Clear Cart button */}
          {cart.length > 0 && (
            <div className="px-4 py-2 bg-[#ECDCB9] border-b border-gray-100">
              <button
                onClick={clearCart}
          ...
          <div className="flex-1 overflow-y-auto p-4 bg-[#ECDCB9]">
            {cart.length === 0 ? (
          ...
          {cart.length > 0 && (
            <div className="p-4 bg-[#ECDCB9] border-t border-orange-100">
